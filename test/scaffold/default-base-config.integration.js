...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    ritod.spawn.datadir.should.equal(home + '/.rito');
    ritod.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/ritod'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.ritod.spawn.datadir.should.equal('./data2');
  });
});
