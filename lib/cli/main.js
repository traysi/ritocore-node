...
var ritocorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = ritocorenode.version;
  var create = ritocorenode.scaffold.create;
  var add = ritocorenode.scaffold.add;
  var start = ritocorenode.scaffold.start;
  var remove = ritocorenode.scaffold.remove;
  var callMethod = ritocorenode.scaffold.callMethod;
  var findConfig = ritocorenode.scaffold.findConfig;
  var defaultConfig = ritocorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the Ritocoin database directory')
  ...
  program
    ...
    .option('-c, --config <dir>', 'Specify the directory with Ritocore Node configuration')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `ritocore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ ritocore-node add wallet-service');
      console.log('    $ ritocore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ ritocore-node remove wallet-service');
      console.log('    $ ritocore-node remove insight-api');
      console.log();
    });
