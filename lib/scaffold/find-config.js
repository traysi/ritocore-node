...
/**
 * Will return the path and ritocore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'ritocore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'ritocore-node.json'))
  };
}
